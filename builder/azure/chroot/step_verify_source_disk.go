...
type StepVerifySourceDisk struct {
	...
	get func(context.Context, client.AzureClientSet, hashiDisksSDK.DiskId) (*hashiDisksSDK.Disk, error)
}
...
func (s StepVerifySourceDisk) Run(ctx context.Context, state multistep.StateBag) multistep.StepAction {
	...
	diskId := hashiDisksSDK.NewDiskID(azcli.SubscriptionID(), resource.ResourceGroup, resource.ResourceName.String())
...
func (s StepVerifySourceDisk) getDisk(ctx context.Context, azcli client.AzureClientSet, id hashiDisksSDK.DiskId) (*hashiDisksSDK.Disk, error) {
